...
```{r  fig.height=5, fig.width=6}
{plot(PRAD_dmr_table$avg_beta_diff, -log10(PRAD_dmr_table$q_value), main= "Volcano Plot", log = "y", las = 1,
...
points(PRAD_dmr_table$avg_beta_diff[gstp1], -log10(PRAD_dmr_table$q_value)[gstp1], pch = 16, cex = 1, col = "black")
text(PRAD_dmr_table$avg_beta_diff[gstp1], -log10(PRAD_dmr_table$q_value)[gstp1], "GSTP1", pos = 2)
