...
#'
#' @param tumor_table A matrix of beta-values (fractions) from tumor samples.
#' @param control_table A matrix of beta-values (fractions) from normal/control samples.
#' @param auc_vector An numeric vector generated by [compute_AUC].
#' @param reference_table A data.frame reporting the location of CpG sites (chromosome
...
whole_genome_segmentator <- function(tumor_table, control_table, auc_vector,
                                     reference_table, length_cutoff = 5, na_cutoff = 0, pt_start = 0.05,
                                     normdist = 1e5, ratiosd = 0.4){
  # check parameters
