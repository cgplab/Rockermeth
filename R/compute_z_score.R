...
#' each CpG site
#' @param out_folder Directory where to store the data generated. Default to
#' NULL to skip saving
...
compute_z_score <- function(tumor_table, control_table, dmr_table,
  ...
  if (!is.null(out_folder)) {
    ...
    save(tumor_dmr_beta, control_dmr_beta, 
      file = file.path(out_folder, "dmr_beta_table.rda"))
  }
