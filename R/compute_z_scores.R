...
#' However, using the same assay for 'Normal' and 'Tumor' is strictly recommended.
#'
...
#' @param min_size Minimum number of CpG sites inside DMR. If not reached NAs will be returned instead of z-scores.
