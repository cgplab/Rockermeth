...
#' @param ratiosd Fraction between the standard deviation of AUC values of differentially methylated sites and the
#' total standard deviation of AUC values. Default is 0.4.
...
meth_state_finder <- function(input_signal, input_pos, auc_sd, length_cutoff,
  ...
  # check parameters
  stopifnot(any(is.na(input_signal)))
